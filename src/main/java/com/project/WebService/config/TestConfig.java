...
import com.project.WebService.repositories.OrdemItemRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Category cat1 = new Category(null, "notbook");
		...
		Payment pay1 = new Payment(null, Instant.parse("2019-07-21T04:30:10Z"), o2);
		o1.setPayment(pay1);
